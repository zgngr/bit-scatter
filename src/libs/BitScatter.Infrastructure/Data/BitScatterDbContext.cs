...
public class BitScatterDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<FileManifest>(entity =>
        {
            ...
            entity.Property(e => e.EncryptedKey).HasMaxLength(512);
            entity.Property(e => e.EncryptionSalt).HasMaxLength(512);
            entity.Property(e => e.EncryptionIv).HasMaxLength(128);
            entity.Property(e => e.EncryptionTag).HasMaxLength(128);
