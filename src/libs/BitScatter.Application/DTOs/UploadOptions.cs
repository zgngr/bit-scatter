...
public class UploadOptions
{
    ...
    /// <summary>
    /// Optional encryption password/passphrase.
    /// If provided, all chunks will be encrypted before scattering.
    /// </summary>
    public string? EncryptionPassword { get; set; }

    /// <summary>
    /// If true, chunk storage keys will be randomized GUIDs to prevent grouping/linking chunks.
    /// </summary>
